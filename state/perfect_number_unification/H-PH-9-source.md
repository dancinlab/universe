<!-- MIRROR — 외부 원문 보존본. 출처: dancinlab/archive-TECS-L · math/docs/hypotheses/H-PH-9-perfect-number-string-unification.md
     이 저장소의 판정은 SSOT(../../ARCHITECTURE.json) 의 gate-h003 · 카드 HYPOTHESES/cards/H_003_perfect_number_unification.md 참조.
     아래는 원문 그대로이며 수정하지 않는다. -->
